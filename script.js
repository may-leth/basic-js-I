...
let myArrayAnimals = ["cat", "dog", "fish", "cow", "pig"];
...
console.log(typeof myArrayAnimals);
...
let trueComparison = firstValue != secondValue;
...
let comparacion = 15 < 20; //Realiza la operación de comparación que consideres para que el resultado en consola sea true
